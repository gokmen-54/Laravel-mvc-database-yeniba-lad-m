...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="{{route('web')}}">PHP Türkiye</a>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h2 class="text-white mt-0">{{$yazi3}}</h2>
                        <hr class="divider light my-4" />
                        <p class="text-white-50 mb-4">{{$yazi4}}</p>
                        <a class="btn btn-light btn-xl js-scroll-trigger" href="#services">{{$yazi5}}</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <div id="portfolio">
            <div class="container-fluid p-0">
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="https://tasarim.phpturkiye.net/assets/img/portfolio/fullsize/4.jpg">
                            <img class="img-fluid" src="https://tasarim.phpturkiye.net/assets/img/portfolio/thumbnails/4.jpg" alt="" />
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Category</div>
                                <div class="project-name">Project Name</div>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="https://tasarim.phpturkiye.net/assets/img/portfolio/fullsize/5.jpg">
                            <img class="img-fluid" src="https://tasarim.phpturkiye.net/assets/img/portfolio/thumbnails/5.jpg" alt="" />
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Category</div>
                                <div class="project-name">Project Name</div>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="https://tasarim.phpturkiye.net/assets/img/portfolio/fullsize/6.jpg">
                            <img class="img-fluid" src="https://tasarim.phpturkiye.net/assets/img/portfolio/thumbnails/6.jpg" alt="" />
